...
data = {
    ...
    "JOB_ID": [
        "IT_PROG", "AC_ACCOUNT", "AC_MGR", "MK_REP", "ST_CLERK", "ST_CLERK",
...
employees_with_multiple_jobs = employee_counts[employee_counts >= 2].index.tolist()

print("Employees who did two or more jobs:", employees_with_multiple_jobs)
