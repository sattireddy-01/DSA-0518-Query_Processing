...
# Sample data
data = {
    'EMPLOYEE_ID': [102, 101, 101, 201, 114, 101, 200, 176, 176, 200],
...
employee_jobs_count = df.groupby('EMPLOYEE_ID')['JOB_ID'].count()
print(employee_jobs_count)

# Filter employees with two or more unique job IDs
